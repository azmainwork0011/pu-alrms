...
const allQuestions: Question[] = [
  ...
  { id: 'py-v-3', languageId: 'python', topicId: 'py-variables', type: 'MCQ', question: 'Which is NOT a valid Python variable name?', codeSnippet: null, options: ['_name', 'my_var', '2ndValue', 'camelCase'], correctAnswer: 'C', explanation: 'Python variables cannot start with a number.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'py-fn-3', languageId: 'python', topicId: 'py-functions', type: 'MCQ', question: 'What is a lambda function in Python?', codeSnippet: null, options: ['A recursive function', 'An anonymous inline function', 'A built-in function', 'A class method'], correctAnswer: 'B', explanation: 'Lambda creates anonymous functions using the syntax: lambda args: expression.', difficulty: 'MEDIUM', points: 15 },
  ...
  { id: 'py-oop-2', languageId: 'python', topicId: 'py-oop', type: 'MCQ', question: 'What does super().__init__() do?', codeSnippet: null, options: ['Calls the parent class constructor', 'Creates a new instance', 'Deletes the parent class', 'Imports a module'], correctAnswer: 'A', explanation: 'super() gives access to parent class methods. __init__() calls the constructor.', difficulty: 'MEDIUM', points: 15 },
  ...
  // ── JAVA ──────────────────────────────────────────────
  // Variables & Data Types
  { id: 'java-v-1', languageId: 'java', topicId: 'java-variables', type: 'MCQ', question: 'Which is the default value of an int variable in Java?', codeSnippet: null, options: ['0', '1', 'null', 'undefined'], correctAnswer: 'A', explanation: 'Java initializes int to 0, boolean to false, and object references to null.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'java-v-3', languageId: 'java', topicId: 'java-variables', type: 'MCQ', question: 'Which data type can store the largest integer?', codeSnippet: null, options: ['int', 'long', 'short', 'byte'], correctAnswer: 'B', explanation: 'long is 64-bit (±9.2×10¹⁸), int is 32-bit, short is 16-bit, byte is 8-bit.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'java-fn-5', languageId: 'java', topicId: 'java-functions', type: 'MCQ', question: 'Can a method return multiple values in Java?', codeSnippet: null, options: ['Yes, using comma syntax', 'No, but you can return an array or object', 'Yes, using the multi keyword', 'No, never'], correctAnswer: 'B', explanation: 'Java methods return one value. Use arrays, collections, or custom objects for multiple values.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'java-ac-2', languageId: 'java', topicId: 'java-collections', type: 'MCQ', question: 'Which collection allows duplicate elements?', codeSnippet: null, options: ['Set', 'HashSet', 'ArrayList', 'TreeSet'], correctAnswer: 'C', explanation: 'ArrayList allows duplicates. Set implementations (HashSet, TreeSet) do not.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'java-oop-3', languageId: 'java', topicId: 'java-oop', type: 'MCQ', question: 'Which keyword prevents class inheritance?', codeSnippet: null, options: ['static', 'final', 'abstract', 'sealed'], correctAnswer: 'B', explanation: 'final class cannot be extended. final methods cannot be overridden.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'java-oop-5', languageId: 'java', topicId: 'java-oop', type: 'MCQ', question: 'What is an interface in Java?', codeSnippet: null, options: ['A class with private methods only', 'A contract that defines method signatures', 'A data structure', 'A type of loop'], correctAnswer: 'B', explanation: 'An interface defines what methods a class must implement (a contract).', difficulty: 'EASY', points: 10 },

  // ── JAVASCRIPT ─────────────────────────────────────────
  // Variables & Data Types
  { id: 'js-v-1', languageId: 'javascript', topicId: 'js-variables', type: 'MCQ', question: 'What is the difference between let and var?', codeSnippet: null, options: ['let is block-scoped, var is function-scoped', 'No difference', 'var is block-scoped, let is function-scoped', 'let cannot be reassigned'], correctAnswer: 'A', explanation: 'let is block-scoped ({}), var is function-scoped and hoisted.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'js-fn-3', languageId: 'javascript', topicId: 'js-functions', type: 'MCQ', question: 'What does the spread operator (...) do?', codeSnippet: null, options: ['Removes an element from array', 'Expands iterable into individual elements', 'Creates a deep copy', 'Sorts the array'], correctAnswer: 'B', explanation: 'Spread operator expands iterables: [...arr] or func(...args).', difficulty: 'EASY', points: 10 },
  ...
  { id: 'js-ao-3', languageId: 'javascript', topicId: 'js-arrays', type: 'MCQ', question: 'Which method does NOT modify the original array?', codeSnippet: null, options: ['push()', 'splice()', 'map()', 'sort()'], correctAnswer: 'C', explanation: 'map() returns a new array. push, splice, and sort modify the original.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'kt-v-4', languageId: 'kotlin', topicId: 'kt-variables', type: 'MCQ', question: 'What is the type inferred for: val list = listOf(1, 2, 3)?', codeSnippet: null, options: ['ArrayList<Int>', 'List<Int>', 'MutableList<Int>', 'Array<Int>'], correctAnswer: 'B', explanation: 'listOf() returns immutable List<T>. Use mutableListOf() for mutable version.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'kt-fn-2', languageId: 'kotlin', topicId: 'kt-functions', type: 'MCQ', question: 'What is an extension function in Kotlin?', codeSnippet: null, options: ['A function that extends class hierarchy', 'A function added to a class without modifying it', 'A recursive function', 'An abstract function'], correctAnswer: 'B', explanation: 'Extension functions add new functions to existing classes without inheritance.', difficulty: 'MEDIUM', points: 15 },
  ...
  { id: 'kt-co-3', languageId: 'kotlin', topicId: 'kt-collections', type: 'MCQ', question: 'What is the difference between List and MutableList?', codeSnippet: null, options: ['List is immutable, MutableList is mutable', 'List is faster', 'MutableList is deprecated', 'No difference'], correctAnswer: 'A', explanation: 'List is read-only. MutableList allows add, remove, set operations.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'kt-oop-3', languageId: 'kotlin', topicId: 'kt-oop', type: 'MCQ', question: 'What is a sealed class?', codeSnippet: null, options: ['A class that cannot be inherited', 'A restricted class hierarchy', 'An encrypted class', 'A final class'], correctAnswer: 'B', explanation: 'Sealed class restricts inheritance to defined subclasses in the same file.', difficulty: 'MEDIUM', points: 15 },
  ...
  // ── DART ───────────────────────────────────────────────
  { id: 'dart-v-1', languageId: 'dart', topicId: 'dart-variables', type: 'MCQ', question: 'What is the correct way to declare a variable in Dart?', codeSnippet: null, options: ['let x = 5;', 'var x = 5;', 'int x := 5;', 'dim x = 5;'], correctAnswer: 'B', explanation: 'Dart uses var for type-inferred variables, or explicit types like int x = 5;.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'dart-v-4', languageId: 'dart', topicId: 'dart-variables', type: 'MCQ', question: 'What does late keyword mean in Dart?', codeSnippet: null, options: ['The variable is deprecated', 'The variable will be initialized later', 'The variable is lazy', 'The variable is constant'], correctAnswer: 'B', explanation: 'late tells Dart the variable will be initialized before use, enabling non-null types without immediate init.', difficulty: 'MEDIUM', points: 15 },
  ...
  { id: 'dart-fn-2', languageId: 'dart', topicId: 'dart-functions', type: 'MCQ', question: 'What is a Future in Dart?', codeSnippet: null, options: ['A value that will be available later', 'A loop construct', 'A data type', 'An array'], correctAnswer: 'A', explanation: 'Future represents a value or error that will be available asynchronously.', difficulty: 'MEDIUM', points: 15 },
  ...
  // Collections
  { id: 'dart-co-1', languageId: 'dart', topicId: 'dart-collections', type: 'MCQ', question: 'Which is NOT a built-in Dart collection?', codeSnippet: null, options: ['List', 'Set', 'Map', 'Tuple'], correctAnswer: 'D', explanation: 'Dart has List, Set, and Map as built-in collections. No Tuple type.', difficulty: 'EASY', points: 10 },
  ...
  // OOP
  { id: 'dart-oop-1', languageId: 'dart', topicId: 'dart-oop', type: 'MCQ', question: 'What is a mixin in Dart?', codeSnippet: null, options: ['A way to share code between classes', 'A type of variable', 'A loop', 'A constructor type'], correctAnswer: 'A', explanation: 'Mixins allow injecting methods/properties into classes without inheritance.', difficulty: 'MEDIUM', points: 15 },
  ...
  // ── SWIFT ──────────────────────────────────────────────
  { id: 'swift-v-1', languageId: 'swift', topicId: 'swift-variables', type: 'MCQ', question: 'What keyword declares a constant in Swift?', codeSnippet: null, options: ['const', 'let', 'val', 'final'], correctAnswer: 'B', explanation: 'Swift uses let for constants and var for variables.', difficulty: 'EASY', points: 10 },
  ...
  { id: 'swift-fn-2', languageId: 'swift', topicId: 'swift-functions', type: 'MCQ', question: 'What is a closure in Swift?', codeSnippet: null, options: ['Self-contained block of code that can be passed around', 'A class constructor', 'A type alias', 'An import statement'], correctAnswer: 'A', explanation: 'Closures are self-contained code blocks like { (params) -> return in body }.', difficulty: 'MEDIUM', points: 15 },
